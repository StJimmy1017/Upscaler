...
from upscaler import nninterp, txsal, lanczos, cubic, area
import os
import io
...
class ImageUpscalerApp:
    ...
    def __init__(self):
        self.image_path = ""
        self.upscaling_method = "Nearest-neighbour interpolation"
    ...
    def upscale_image(self):
        ...
        try:
            ...
            if self.upscaling_method == 'Nearest-neighbour interpolation':
                upscaled_image = nninterp(source_image)
            elif self.upscaling_method == '2xSal Scaling':
